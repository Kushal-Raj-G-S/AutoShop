class AppConfig {
  ...
  // Download ngrok.com, run: ngrok http 3000
  // Use the URL it gives you (e.g., https://abc123.ngrok.io)
  static const String backendHost = '10.110.12.220'; // 👈 CHANGE THIS

  static const String backendPort = '5000'; // Node.js backend port

  // Auto-generated URLs - Don't change these
  static const String baseUrl = 'http://$backendHost:$backendPort/api';
  static const String wsUrl =
      'http://$backendHost:$backendPort'; // Socket.io URL
